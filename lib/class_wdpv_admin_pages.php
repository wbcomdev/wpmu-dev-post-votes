...
class Wdpv_AdminPages {
	...
	function register_settings () {
		...
		add_settings_section('wdpv_voting', __('Voting settings', 'wdpv'), array( $form, 'create_function' ), 'wdpv_voting');
		...
		if (defined('BP_VERSION')) {
			add_settings_section('wdpv_bp', __('BuddyPress integration', 'wdpv'), array( $form, 'create_function' ), 'wdpv_options_page');
		...
		if (!is_multisite() || (is_multisite() && is_network_admin())) { // On multisite, plugins are available only on network admin pages
			add_settings_section('wdpv_plugins', __('Post Voting add-ons', 'wdpv'), array( $form, 'create_function' ), 'wdpv_options_page');
